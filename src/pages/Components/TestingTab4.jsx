...
let data = [
  {
    name: "Overview",
    text: "A framework is a pre-designed set of software components that provides a structure for building and organizing applications. It offers a foundation for developers to build upon and reduces the amount of repetitive coding required in software development.",
  },
  {
    name: "Course Details",
    text: (
              ...
              <li>
                <div className="row">
                  ...
                  <div className="courseDetails col">
                    ...
                    Jenkins
                    <br />
                    Xpath,ChromeOptions,BrokenLinks & Images
                    <br />
                    JDBC
                    <br />
                    Singleton
...
class TestingTab4 extends React.Component {
  constructor() {
    super();
