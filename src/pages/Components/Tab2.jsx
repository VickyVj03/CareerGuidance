...
let data = [
  {
    name: "Overview",
    text: "HTML (Hypertext Markup Language) is a markup language used to create the structure and content of web pages. It consists of a series of tags and attributes that define how the content is displayed in a web browser. HTML is a fundamental technology for building websites and is often used in conjunction with CSS and JavaScript.",
  },
  {
    name: "Course Details",
    text: (
